...
/**
   ...
   */
export declare function get(url: string, headers: string): Promise<phin.IJSONResponse<unknown>>;
/**
   ...
   */
export declare function randomArray(arr: string, path?: string): string;
/**
   ...
   */
export declare function ratelimit(time: number, data: string): Promise<unknown>;
export { delay };
